Para definir o timezone como "America/Belem" tanto no sistema operacional do contêiner quanto no PHP, você pode ajustar o Dockerfile e o php.ini conforme necessário. Aqui estão os passos:
